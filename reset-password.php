...
<head>
    <meta charset="UTF-8">
    <title>Reset New Password | Kevin's Express Studio</title>
...
<body class="reset-password-page">
    <section id="reset-password-section"
        class="reset-password-section dark-background align-items-center justify-content-center min-vh-100">
        <video src="assets/video/mainvideo.mp4" autoplay muted loop playsinline></video>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <form action="process/ResetPasswordProcess.php" method="post" class="reset-password-form">

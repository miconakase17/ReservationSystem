...
<body class="login-page">
    <?php if ($message): ?>
        <div id="error-popup" class="error-popup show">
    ...
    <section id="login-section" class="login-section dark-background align-items-center justify-content-center min-vh-100">

...
if ($stmt->execute()) {
    ...
    if ($user && !empty($user['email'])) {
        ...
        try {
            ...
            $mail->Body = "
                ...
                <p>Your reservation for <b>$serviceType</b> on <b>$date</b> from <b>$startTime</b> to <b>$endTime</b> has been <b>cancelled</b>.</p>
    ...
    echo json_encode([
        "success" => true,
        "message" => "Reservation cancelled and email sent."
    ]);
} else {
    echo json_encode([
        "success" => false,
